    ...
    <header className="h-16 border-b border-gray-200 bg-gray-50 flex items-center justify-between px-4 md:px-6 shrink-0 z-50">
      ...
      <div className="flex-1 max-w-md mx-4 hidden sm:block">
        <button
          ...
          className={cn(
            "group relative flex w-full items-center gap-3 rounded-xl border border-gray-200 bg-white px-3.5 py-2 text-left text-sm shadow-sm transition-all duration-200",
            "hover:border-green-400 hover:shadow-green-100 hover:shadow-md focus:outline-none",
          )}
        >
          ...
          <kbd className="inline-flex items-center rounded-md border border-gray-200 bg-gray-50 px-1.5 py-0.5 text-[11px] font-semibold text-gray-400 shadow-sm group-hover:border-green-200 group-hover:bg-green-50 group-hover:text-green-600 transition-colors">
            ⌘K
          </kbd>
        </button>
      </div>
      ...
      <div className="flex items-center gap-3">
        <button
          onClick={openShortcuts}
          className="flex sm:hidden items-center justify-center h-9 w-9 rounded-lg border border-gray-200 bg-white text-gray-500 hover:bg-green-50 hover:text-green-600 hover:border-green-300 transition-all shadow-sm"
